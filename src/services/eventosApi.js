...
//   existente: {semInteracao,semNegociacao,oportunidade,negociacaoPerdida,negociacaoGanha}
//   novo:      {prospect,oportunidade,negocioGanho}
...
function withDerivedTotals(evento) {
  ...
  return {
    ...evento,
    prospects: g(c.existente, 'semInteracao') + g(c.novo, 'prospect') + g(n.existente, 'semInteracao') + g(n.novo, 'prospect'),
    convidados: g(c.existente, 'semNegociacao') + g(n.existente, 'semNegociacao'),
    oportunidadesNovas: g(c.novo, 'oportunidade') + g(n.novo, 'oportunidade'),
    oportunidadesExistentes: g(c.existente, 'oportunidade') + g(c.existente, 'negociacaoPerdida') + g(n.existente, 'oportunidade') + g(n.existente, 'negociacaoPerdida'),
    negociosGanhosNovos: g(c.novo, 'negocioGanho') + g(n.novo, 'negocioGanho'),
    negociosGanhosExistentes: g(c.existente, 'negociacaoGanha') + g(n.existente, 'negociacaoGanha'),
