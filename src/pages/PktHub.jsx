    ...
    <div className="hub-layout">
      ...
      <div className="hub-right">
        ...
        <main className="hub-main">
          ...
          {!activeAgent && activeTab === 'Metas' && (
            <section className="hub-main__section">
              <h2 className="hub-main__section-title">Metas Semanais</h2>
              <div className="hub-main__grid">
                <button className="hub-card" onClick={() => navigate('/metas-semanais')}>
                  <span className="hub-card__tag hub-card__tag--geral">Geral</span>
                  <div className="hub-card__icon hub-card__icon--geral">🎯</div>
                  <h3 className="hub-card__title">B2C + B2B</h3>
                  <p className="hub-card__desc">Meta semanal de cada vendedor, por programa, vs. realizado, e cadência média até fechar 1 negócio.</p>
                  <span className="hub-card__status hub-card__status--live">Ao vivo</span>
                </button>
                <button className="hub-card" onClick={() => navigate('/metas-semanais?segment=b2c')}>
                  <span className="hub-card__tag">B2C</span>
                  <div className="hub-card__icon hub-card__icon--b2c">🎯</div>
                  <h3 className="hub-card__title">Metas B2C</h3>
                  <p className="hub-card__desc">Painel de metas semanais dos vendedores B2C, por programa.</p>
                  <span className="hub-card__status hub-card__status--live">Ao vivo</span>
                </button>
                <button className="hub-card" onClick={() => navigate('/metas-semanais?segment=b2b')}>
                  <span className="hub-card__tag hub-card__tag--b2b">B2B</span>
                  <div className="hub-card__icon">🎯</div>
                  <h3 className="hub-card__title">Metas B2B</h3>
                  <p className="hub-card__desc">Painel de metas semanais dos vendedores B2B, por programa.</p>
                  <span className="hub-card__status hub-card__status--live">Ao vivo</span>
                </button>
              </div>
            </section>
